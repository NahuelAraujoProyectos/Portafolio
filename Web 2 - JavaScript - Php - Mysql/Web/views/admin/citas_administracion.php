...
<head>
    ...
    <script src="../../js/adm_citaciones.js"></script>
    <!--CSS-->
    <link rel="stylesheet" href="../../css/style.css">
    <link rel="stylesheet" href="../../css/adm_citaciones.css">
    <!-- Fuentes -->
    ...
    <main>
        ...
        <section id="contenido">
            <div id="titulo_seccion" class="container-fluid">
                <div class="container">
                    <h1>Citaciones-Administración</h1>
                </div>
            </div>
            <div class="container">
                <div class="row" id="contenido_citas">
                    <div id="div_contenido">
                        ...
                        <div id="citas_opciones">
                            <button type="button" id="btn_ver_citas" class="btn btn-success" disabled>Ver Citas</button>
                            <button type="button" id="btn_crear_cita" class="btn btn-success" disabled>Crear Citas</button>
                            <hr>
                        </div>
                        <!--Respuestas-->
