...
<head>
    ...
    <script src="../../js/adm_usuarios.js"></script>
    <!--CSS-->
...
<body>
    ...
    <main>
        ...
        <section id="usuario_administracion">
            ...
            <div class="container">
                <div class="row" id="contenido_usuarios">
                    <div id="div_contenido">
                        ...
                        <div id="usuarios_opciones">
                            <button type="button" id="btn_ver_usuario" class="btn btn-success">Ver Usuarios</button>
                            <button type="button" id="btn_crear_usuario" class="btn btn-success">Crear Usuario</button>
                            <hr>
                        </div>
                        <!--Respuestas-->
                        <div id="respuesta"></div>  
                        <!--Ver usuarios creados-->
                        <div id="ver_usuarios" class="row">
                        </div>
                        <!--Registrar usuarios nuevos-->
                        <div id="crear_usuario" class="row">
                        </div>
                    </div>
                </div>
            </div>
