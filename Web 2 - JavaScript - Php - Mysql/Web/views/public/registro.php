...
<head>
    ...
    <script src="../../js/public_usuarios.js"></script>
    <!--CSS-->
...
<body>
    <!-- Navbar Start -->
    <header>
        <nav class="navbar navbar-expand-xl navbar-static-top fixed-top navbar-dark bg-dark">
        <div class="container">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                <a id="nav_registro" class="nav-link" href="#">Registro</a>
                </li>
                <li class="nav-item">
    ...
    <main>
        ...
        <section id="registro">
            ...
            <div class="container">
                <div class="row" id="contenido_registro">
