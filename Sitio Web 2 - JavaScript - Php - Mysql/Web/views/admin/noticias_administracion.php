...
<head>
    ...
    <link rel="stylesheet" href="../../css/adm_noticias.css">
    <!-- Fuentes -->
            ...
            <div class="container">
                <div class="row" id="contenido_noticias">
                    <div id="div_contenido">
                        ...
                        <div id="noticias_opciones">
                            <button type="button" id="btn_ver_noticias" class="btn btn-success">Ver Noticias</button>
                            <button type="button" id="btn_crear_noticias" class="btn btn-success">Crear Noticias</button>
                            <hr>
                        </div>
                        <!--Respuestas-->
                        ...
                        <div id="crear_noticias" class="row">
                        </div>
                    </div>
                </div>
            </div>
